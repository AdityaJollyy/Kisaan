...
import Loader from "../components/Loader"; // 🔁 Add this if you haven't already
...
function MessageRouter() {
  ...
  return user?.role === "farmer" ? <FarmerMessagesPage /> : <ConversationPage />;
}
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route element={<PrivateRoute />}>
            ...
            <Route path="messages/:userId" element={<MessageRouter />} />
